...
app.all('/api/5d/draw', wrapVercelRoute(require('../../api/5d/draw')));
app.all('/api/5d/bet', wrapVercelRoute(require('../../api/5d/bet')));
app.all('/api/admin/resolve-draw', wrapVercelRoute(require('../../api/admin/resolve-draw')));
